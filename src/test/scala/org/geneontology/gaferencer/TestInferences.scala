...
object TestInferences extends TestSuite {
  ...
  val tests = Tests {
    ...
    "Check inferred annotations" - {
      ...
      assert(grouped(ExtendedAnnotation(Link(InvolvedIn, Class("http://purl.obolibrary.org/obo/GO_0006412")), Mouse, Set(Link(OccursIn, Class("http://purl.obolibrary.org/obo/GO_0005739")))))
        .head.inferences(Link(InvolvedIn, Class("http://purl.obolibrary.org/obo/GO_0032543"))))
      assert(grouped(ExtendedAnnotation(Link(InvolvedIn, Class("http://purl.obolibrary.org/obo/GO_0048585")), Mouse, Set(Link(Regulates, Class("http://purl.obolibrary.org/obo/GO_0051594")))))
